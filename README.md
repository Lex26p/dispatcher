...
`CORE-006 — Device Manager` находится в разработке. Step 1 подтверждён commit `c79ff405284dbed1d0dc9ac3340f97dbcfa217cd`, Step 2 — `cfba346eb7943fcd345bdb972c7bfec41b339b9f`. Step 3 добавляет service-local SQLite schema v1 для durable Device/Metric metadata и project associations, атомарное сохранение/загрузку catalog и reopen/schema-version regression. После подтверждения Step 3 следующий шаг — Step 4: versioned external contract и Service Hub provider.
