...
В репозитории зафиксированы правила совместной работы, промежуточная общая продуктовая концепция, реестр продуктовых решений и углублённая рабочая концепция дашбордов и мнемосхем. Дорожная карта, программная архитектура и исходный код ещё не создаются.
