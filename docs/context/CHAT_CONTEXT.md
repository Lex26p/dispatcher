...
`CORE-001 — Data Hub` завершён и прошёл финальный acceptance.

Следующий спринт — `CORE-002 — Service Hub`. Перед его реализацией нужно отдельно согласовать подробные шаги и минимальный контракт.
